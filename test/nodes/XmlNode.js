...
describe("XmlNode", () => {
    ...
    describe("#children", () => {
        ...
        it("should return a copy of the array containing this node's" +
            ...
            let node = new XmlNode();
            assert.notStrictEqual(node.children(), node._children);
        });
    });
    ...
    describe("#insertChild", () => {
        it("should throw an error if the specified node is not an" +
            " XmlNode", () => {
            let node = new XmlNode();
            assert.throws(() => node.insertChild(undefined));
            assert.throws(() => node.insertChild(null));
            assert.throws(() => node.insertChild(0));
            assert.throws(() => node.insertChild("error"));
        });
        ...
        it("should throw an error if the specified index is not an" +
            ...
            let parentNode = new XmlNode();
            let childNode = new XmlNode();
            assert.throws(() => parentNode.insertChild(childNode, null));
            assert.throws(() => parentNode.insertChild(childNode, "error"));
            assert.throws(() => parentNode.insertChild(childNode, 3.3));
        });
        ...
        it("should throw an error if the specified index is not within the" +
            ...
            assert.throws(() => parentNode.insertChild(secondChildNode,
        ...
        it("should insert the specified node at the appropriate location in" +
            ...
            assert.strictEqual(parentNode.insertChild(thirdChildNode,
                parentNode.children().length), thirdChildNode);
            assert.strictEqual(
    ...
    describe("#removeChild", () => {
        it("should throw an error if the specified node is not an" +
            " XmlNode", () => {
            let node = new XmlNode();
            assert.throws(() => node.removeChild(undefined));
            assert.throws(() => node.removeChild(null));
            assert.throws(() => node.removeChild(0));
            assert.throws(() => node.removeChild("error"));
        });
    ...
    describe("#removeChildAtIndex", () => {
        it("should throw an error if the specified index is not an" +
            ...
            let node = new XmlNode();
            assert.throws(() => node.removeChildAtIndex(null));
            assert.throws(() => node.removeChildAtIndex("error"));
            assert.throws(() => node.removeChildAtIndex(3.3));
        });
