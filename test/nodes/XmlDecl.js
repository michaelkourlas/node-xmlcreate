...
describe("XmlDecl", () => {
    ...
    describe("#encoding", () => {
        ...
        it("should throw an error if the specified value is not a" +
            " string or undefined", () => {
            let node = new XmlDecl();
            assert.throws(() => node.encoding = null);
            assert.throws(() => node.encoding = 0);
            assert.throws(() => node.encoding = new XmlDecl());
        });
    ...
    describe("#standalone", () => {
        ...
        it("should throw an error if the specified value is not a" +
            " string or undefined", () => {
            let node = new XmlDecl();
            assert.throws(() => node.standalone = null);
            assert.throws(() => node.standalone = 0);
            assert.throws(() => node.standalone = new XmlDecl());
        });
    ...
    describe("#version", () => {
        ...
        it("should throw an error if the specified value is not a" +
            " string", () => {
            let node = new XmlDecl();
            assert.throws(() => node.version = undefined);
            assert.throws(() => node.version = null);
            assert.throws(() => node.version = 0);
            assert.throws(() => node.version = new XmlDecl());
        });
