...
import {XmlText} from "../../lib/main";

describe("XmlText", () => {
    describe("#constructor", () => {
        it("should create an XmlText node with the specified text", () => {
    ...
    describe("#text", () => {
        ...
        it("should throw an error if the specified value is not a" +
            " string", () => {
            let node = new XmlText("abc");
            assert.throws(() => node.text = undefined);
            assert.throws(() => node.text = null);
            assert.throws(() => node.text = 0);
            assert.throws(() => node.text = new XmlText(""));
        });
