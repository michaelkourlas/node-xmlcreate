...
describe("XmlProcInst", () => {
    ...
    describe("#target", () => {
        ...
        it("should throw an error if the specified value is not a" +
            " string", () => {
            let node = new XmlProcInst("abc");
            assert.throws(() => node.target = undefined);
            assert.throws(() => node.target = null);
            assert.throws(() => node.target = 0);
            assert.throws(() => node.target = new XmlProcInst("target"));
        });
    ...
    describe("#content", () => {
        ...
        it("should throw an error if the specified value is not a" +
            " string or undefined", () => {
            let node = new XmlProcInst("abc", "def");
            assert.throws(() => node.content = null);
            assert.throws(() => node.content = 0);
            assert.throws(() => node.content = new XmlProcInst("target"));
        });
