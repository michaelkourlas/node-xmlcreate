...
describe("XmlElement", () => {
    ...
    describe("#toString", () => {
        ...
        it(
            "normal name; default replace invalid chars; no attributes;" +
        ...
        it(
            "name with characters not allowed in XML names; replace" +
                " invalid chars; no attributes; no children; default quotes;" +
                " default pretty printing; default indentation; default" +
                " newline",
            () => {
        ...
        it(
            "normal name; default replace invalid chars; attributes; no" +
        ...
        it(
            "normal name; default replace invalid chars; no attributes;" +
                " single empty child; default quotes; default pretty" +
        ...
        it(
            "normal name; default replace invalid chars; no attributes;" +
                " single empty child with self-closing tag enabled; default" +
                " quotes; default pretty printing; default indentation;" +
                " default newline",
            () => {
                const node = new XmlElement(undefined, true, {
                    name: "abc",
        ...
        it(
            "normal name; default replace invalid chars; no attributes;" +
                " single empty child with self-closing tag disabled; default" +
                " quotes; default pretty printing; default indentation;" +
                " default newline",
            () => {
                const node = new XmlElement(undefined, true, {
        ...
        it(
            "normal name; default replace invalid chars; no attributes; no" +
        ...
        it(
            "normal name; default replace invalid chars; no attributes;" +
                " children; default quotes; default pretty printing;" +
