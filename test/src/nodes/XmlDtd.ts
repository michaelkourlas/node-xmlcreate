...
describe("XmlDtd", () => {
    it("#attlist", () => {
        ...
        assert.isTrue(
            node.attlist({charData: "test"}) instanceof XmlDtdAttlist
        );
        assert.isTrue(
            node.attlist({charData: "test2"}) instanceof XmlDtdAttlist
        );
        assert.strictEqual(
            node.toString(),
            "<!DOCTYPE abc [\n    <!ATTLIST test>\n    <!ATTLIST test2>\n]>"
    ...
    it("#element", () => {
        const node = new XmlDtd(undefined, false, {name: "abc"});
        assert.isTrue(
            node.element({charData: "test"}) instanceof XmlDtdElement
        );
        assert.isTrue(
            node.element({charData: "test2"}) instanceof XmlDtdElement
        );
        assert.strictEqual(
            node.toString(),
            "<!DOCTYPE abc [\n    <!ELEMENT test>\n    <!ELEMENT test2>\n]>"
    ...
    it("#notation", () => {
        const node = new XmlDtd(undefined, false, {name: "abc"});
        assert.isTrue(
            node.notation({charData: "test"}) instanceof XmlDtdNotation
        );
        assert.isTrue(
            node.notation({charData: "test2"}) instanceof XmlDtdNotation
        );
        assert.strictEqual(
            node.toString(),
            "<!DOCTYPE abc [\n    <!NOTATION test>\n    <!NOTATION test2>\n]>"
    ...
    it("#paramEntityRef", () => {
        const node = new XmlDtd(undefined, false, {name: "abc"});
        assert.isTrue(
            node.paramEntityRef({name: "test"}) instanceof XmlDtdParamEntityRef
        );
        assert.isTrue(
            node.paramEntityRef({name: "test2"}) instanceof XmlDtdParamEntityRef
        );
        assert.strictEqual(
            node.toString(),
            "<!DOCTYPE abc [\n    %test;\n    %test2;\n]>"
    ...
    it("#procInst", () => {
        const node = new XmlDtd(undefined, false, {name: "abc"});
        assert.isTrue(
            node.procInst({target: "test", content: "a"}) instanceof XmlProcInst
        );
        assert.isTrue(node.procInst({target: "test2"}) instanceof XmlProcInst);
        assert.strictEqual(
            node.toString(),
            "<!DOCTYPE abc [\n    <?test a?>\n    <?test2?>\n]>"
        );
    ...
    describe("#toString", () => {
        it(
            "normal name; normal sysId; normal pubId; no children;" +
        ...
        it(
            "normal name; normal sysId; normal pubId; children;" +
                " default quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                const node = new XmlDtd(undefined, true, {
        ...
        it(
            "normal name; normal sysId; no pubId; no children;" +
                " default quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                assert.strictEqual(
        ...
        it(
            "normal name; normal sysId; no pubId; children;" +
                " default quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                const node = new XmlDtd(undefined, true, {
        ...
        it(
            "normal name; no sysId; no pubId; no children;" +
                " default quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                assert.strictEqual(
        ...
        it(
            "normal name; no sysId; no pubId; children;" +
                " default quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
        ...
        it(
            "name with characters not allowed in XML names;" +
        ...
        it(
            "normal name; normal sysId; pubId with characters not allowed in" +
        ...
        it(
            "normal name; sysId with characters not allowed in" +
        ...
        it(
            "normal name; no sysId; normal pubId; no children;" +
                " default quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                assert.throws(
        ...
        it(
            "normal name; sysId with single quotes; normal pubId; children;" +
                " single quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                assert.throws(() => {
        ...
        it(
            "normal name; sysId with double quotes; normal pubId; children;" +
                " double quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                assert.throws(() => {
        ...
        it(
            "normal name; normal sysId; pubId with single quotes; children;" +
                " double quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                assert.throws(() => {
        ...
        it(
            "normal name; normal sysId; pubId with double quotes; children;" +
                " double quotes; default pretty printing;" +
                " default indentation; default newline",
            () => {
                assert.throws(() => {
